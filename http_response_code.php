...
define('HTTP_RESPONSE_UNAUTHORIZED',401); // provide new credentials and try again.
define('HTTP_RESPONSE_PAYMENT_REQUIRED',402);
define('HTTP_RESPONSE_FORBIDDEN',403); // we understood your credentials and we don't like you. GO AWAY.
...
define('HTTP_RESPONSE_NOT_IMPLEMENED',501);
